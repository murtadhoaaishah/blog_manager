...
import type { BlogPost, BlogPostInput, ValidationError } from '../types/BlogPost';
...
export const BlogForm = ({ editingPost, onCancel, onSuccess, handleAddPost }: BlogFormProps) => {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.title.trim()) {
      ...
      newErrors.push({ field: 'title', message: 'Title must be at least 5 characters' });
    }
